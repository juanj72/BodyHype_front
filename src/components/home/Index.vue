        ...
        <nav class="navbar">
            <ul class="nav-list">
                <li class="nav-item">
                    ...
                    <RouterLink :to="{ name: 'homeindex' }"> Personas</RouterLink>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal"><font-awesome-icon
                            :icon="['fas', 'arrow-right-from-bracket']" /> logout </a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Body Hype App Dice</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn " style="background-color: blueviolet; color: aliceblue;"  @click="logout" data-bs-dismiss="modal">Si, salir</button>
                    </div>
                </div>
            </div>
        </div>
...
.nav-item a {
    ...
    color: #fff;
    /* Color del texto de los elementos de la barra de navegación */
    font-size: 18px;
}
