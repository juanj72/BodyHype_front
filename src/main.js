...
library.add(faListCheck,faClipboardQuestion,faHouse,faGlobe,faPencil,faFloppyDisk,faWeightHanging,faHandHoldingDollar)
library.add(faAddressBook,faCalendarCheck,faCommentsDollar,faArrowRightFromBracket,faPenToSquare,faCreditCard)
