<template>
    <div class="container" v-for="datos in data" :key="datos.id">
        <div class="row">
            <h1>Perfil</h1>
            <hr>
        </div>
...
.p-3 {
    background-color: rgb(212, 166, 238);
}
</style>